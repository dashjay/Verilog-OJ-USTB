      ...
      <Kane :padding="40" shadow>
        ...
        <div id="problem-content" class="markdown-body" v-katex>
          ...
          <div class="content">
            ...
            <Timeline>
              <TimelineItem v-for="solution in solutions" :key="solution.id">
        ...
        <Split v-model="split" v-if="submitted">
          ...
          <div slot="right" class="demo-split-pane">
            <Card style="padding-left: 10px;height: 500px">
              <Spin size="large" v-if="submitting" fix></Spin>
              <p slot="title">波形</p>
              <div>Yours</div>
    ...
    <div id="right-column">
      ...
      <Card id="pieChart" :padding="0">
        <div slot="title">
          ...
          <!--                    <Button type="primary" size="small" id="detail" @click="graphVisible = !graphVisible">Details-->
          <!--                    </Button>-->
        </div>
        <div class="echarts">
        ...
        methods: {
            ...
            changePie() {
                ...
                api.getSolutionInfo(this.problem.id)
                    .then(response => {
                        if (response.data.status) {
                            let problemdata = response.data.object;
                            let data = [
                                {name: 'fail', value: problemdata.total - problemdata.pass},
                                {name: 'pass', value: problemdata.pass}
                            ];
